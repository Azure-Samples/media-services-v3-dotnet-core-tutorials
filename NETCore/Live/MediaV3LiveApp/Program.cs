...
namespace LiveSample
{
    class Program
    {
        ...
        /// </summary>
        /// <param name="config">The parm is of type ConfigWrapper. This class reads values from local configuration file.</param>
        /// <returns>ServiceCredentials that can be used to create an Azure Media Services client instance.</returns>
        ...
        /// </summary>
        /// <param name="config">The parm is of type ConfigWrapper. This class reads values from local configuration file.</param>
        /// <returns>an Azure Media Services client instance</returns>
        ...
        /// </summary>
        /// <param name="client">Azure Media Services client instance to use</param>
        /// <param name="resourceGroup">The Resource Group containing the Azure Media Services account.</param>
        /// <param name="accountName">The name of the Azure Media Services account.</param>
        /// <param name="liveEventName">The name of the LiveEvent to delete.</param>
        ...
        /// <param name="resourceGroup">The Resource Group containing the Azure Media Services account.</param>
        /// <param name="accountName">The name of the Azure Media Services account.</param>
        /// <param name="streamingLocatorName">The name of the StreamingLocator to delete.</param>
        /// <param name="assetName">The name of the Asset to delete.</param>
        /// <returns>Async task</returns>
        ...
        /// <param name="resourceGroup">The Resource Group containing the Azure Media Services account.</param>
        /// <param name="accountName">The name of the Azure Media Services account.</param>
        /// <param name="streamingEndpointName">The name of the StreamingEndpoint to stop or delete.</param>
        /// <param name="deleteEndpoint">A value specifying whether the StreamingEndpoint should be deleted after it is stopped.</param>
        /// <returns>Async task</returns>
